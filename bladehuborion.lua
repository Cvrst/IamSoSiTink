...
return math.floor(tonumber(n)if game.PlaceId == 2753915549 then
    World1 = true
...
local Window = OrionLib:MakeWindow({Name = "Blade Hub Orion(Beta)", HidePremium = false, IntroText = "Blade Library", SaveConfig = true, ConfigFolder = "Blade Hub"})
----------Tab-----------------------
...
M:AddDropdown({
    Name = "Select Weapon",
    Default = "This is for farming,(Don't use fruit and gun to farm plz)",
    Options = WeaponList,
    Flag = "Select Weapon",
    Save = true,
...
M:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto Collect Azure Amber",
    Save = true,
    Callback = function(v)
        _G.CollectAzure = v
...
M:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Esp Kitsune Island",
    Save = true,
    Callback = function(v)
        KitsuneEsp = v
...
M:AddToggle({
    Name = "Attack TerrorShark",
    Default = false,
    Flag = "Enable it to Attack Terrorshark",
    Save = true,
    Callback = function(value)
...
M:AddToggle({
    Name = "Attack Shark",
    Default = false,
    Flag = "Enable it to Attack Shark",
    Save = true,
    Callback = function(v)
        FarmShark = v
        StopTween(FarmShark)
...
M:AddToggle({
    Name = "Attack Piranha",
    Default = false,
    Flag = "Enable it to Attack Piranha",
    Save = true,
    Callback = function(value)
...
M:AddToggle({
    Name = "Attack FishCrew",
    Default = false,
    Flag = "Enable it to Attack FishCrew",
    Save = true,
    Callback = function(value)
                        ...
                        if v.Name == "Fish Crew Member" then
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                repeat task.wait()
                                    ...
                                    v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                    Iam_So_Si_Tink = true
                                    topos(v.HumanoidRootPrt.CFrame * Pos)
                                    game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
...
M:AddToggle({
    Name = "Fruit Mastery",
    Default = false,
    Flag = "Enable it to Fruit Mastery",
    Save = true,
    Callback = function(Value)
...
M:AddToggle({
    Name = "Gun Mastery",
    Default = false,
    Flag = "Enable it to Gun Mastery,(idk if it works)",
    Save = true,
    Callback = function(Value)
...
Farmfasttoggle = M:AddToggle({
    Name = "Skip nomarl farm",
    Default = false,
    Flag = "Enable it to Farm Fast",
    Save = true,
    Callback = function(Value)
        _G.Farmfast = Value
...
M:AddToggle({
    Name = "One click",
    Default = false,
    Flag = "Enable it to get all items,(i think)",
    Save = true,
    Callback = function(Value)
        _G.RedeemCode = Value
        _G.AutoFarm = Value
...
if World1 then
    M:AddDropdown({
        Name = "Choose Mob",
        Default = "Enable it to choose mob in sea 1",
    ...
    M:AddDropdown({
        Name = "Choose Mob",
        Default = "Enable it to choose mob in sea 2",
    ...
    M:AddDropdown({
        Name = "Choose Mob",
        Default = "Enable it to choose mob in sea 3",
...
M:AddToggle({
    Name = "Hit The Nearest Mob",
    Default = false,
    Flag = "Enable it to Farm Nearest",
    Save = true,
    Callback = function(Value)
...
TweenChest = M:AddToggle({
        Name = "Chest farm nomarl",
        Default = false,
        Flag = "Enable it to Auto Chest",
        Save = true,
        Callback = function(Value)
            AutoFarmChest = Value
    ...
    M:AddToggle({
        Name = "Chest farm fast [90% got kick lmao]",
        Default = false,
        Flag = "Enable it to auto chest [Bypass]",
        Save = true,
        Callback = function(Value)
...
M:AddToggle({
    Name = "Stop chest when it have god chalice and fod",
    Default = false,
    Flag = "Open it to stop Only Dark Key or God's Chalice",
    Save = true,
    Callback = function(Value)
        _G.StopChest = Value
    end    
...
ToggleRandom = M:AddToggle({
        Name = "Auto Ramdom Bone",
        Default = false,
        Flag = "Enable it to Auto Random Bone",
        Save = true,
        Callback = function(Value)
...
local EliteProgress = M:AddLabel("")
    ...
    M:AddToggle({
        Name = "Auto Factory",
        Default = false,
        Flag = "Enable it to Auto Factory",
        Save = true,
        Callback = function(Value)
        ...
        M:AddToggle({
            ...
            Default = false,
            Flag = "Enable it to Auto Pirate Raid",
            Save = true,
            Callback = function(Value)
                _G.RaidPirate = Value
        ...
        M:AddToggle({
            Name = "Auto Katakuri",
            Default = false,
            Flag = "Enable it to Auto Katakuri",
            Save = true,
            Callback = function(Value)
        ...
        M:AddToggle({
            ...
            Default = false,
            Flag = "Enable it to Auto Dought King",
            Save = true,
            Callback = function(Value)
...
M:AddToggle({
    Name = "Auto All Boss",
    Default = false,
    Flag = "Enable it to Farm All Boss",
    Save = true,
    Callback = function(Value)
...
spawn(function()
    ...
    M:AddToggle({
        ...
        Default = false,
        Flag = "Enable it to Farm Observation Haki",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "Auto Observation Haki [But it's hop]",
        Default = false,
        Flag = "Enable it to Farm Observation Haki[HOP]",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        ...
        Default = false,
        Flag = "Enable it to Auto Death Step",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        ...
        Default = false,
        Flag = "Enable it to Auto SharkMan",
        Save = true,
        Callback = function(Value)
 ...
 M:AddToggle({
        ...
        Flag = "Enable it to Auto Electric Claw",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        ...
        Default = false,
        Flag = "Enable it to Auto Dragon Talon",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "Auto GodHuman",
        Default = false,
        Flag = "Enable it to Auto GodHuman",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle({
    Name = "Auto Saber[HOP]",
    Default = false,
    Flag = "Enable it to Auto Saber[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
...
TogglePolev1Hop = IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto Pole[HOP]",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Auto Vampire",
    Default = false,
    Flag = "Enable it to Auto Vampire",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto SuperHuman",
    Save = true,
    Callback = function(Value)
        _G.AutoSuperhuman = Value
...
BartiloToggle = IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto Bartilo",
    Save = true,
    Callback = function(Value)
        _G.AutoBartilo = Value
...
IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto Buddy[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
...
IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto Soul[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value  
    end    
...
IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto ObservationV2",
    Save = true,
    Callback = function(Value)
...
local Section = IQ:AddSection({
    Name = " Dual Curset Katana[Don't use it lol]"
})

IQ:AddToggle({
    Name = "Auto Dual Curset Katana",
    Default = false,
    Flag = "Enable it to Auto DualCursetKatana",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Auto Tushita",
    Default = false,
    Flag = "Enable it to Auto Tushita",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Auto Cavander",
    Default = false,
    Flag = "Enable it to Auto Cavander,(It need your luck too)",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto Cavander[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
    ...
    IQ:AddToggle({
        Name = "Auto Seabeast",
        Default = false,
        Flag = "Enable it to Auto Seabeast",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle({
    ...
    Default = false,
    Flag = "Enable it to Auto Mirrage",
    Save = true,
    Callback = function(Value)
        _G.dao = Value
            if Value then
